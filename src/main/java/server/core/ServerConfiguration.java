...
public class ServerConfiguration
{
    ...
    private int scheduleThreadSize = 18;
    ...
    private Integer bufferPoolSize = 100;
    ...
    public static class ServerConfigurationBuilder
    {
        ...
        public ServerConfigurationBuilder bufferPoolSize(Integer size)
        {
            configuration.bufferPoolSize = size;
            return this;
        }
